...
var cubeeBase = jsbase+'/cubee/' || 'http://a.tbcdn.cn/app/dp/eb/js/cubee/';
...
var yuiCfg = {
	...
	comboBase:"http://a.tbcdn.cn/app/dp/lite/cb.php?",
	combine:false,
	//combine:true,
	loadOptional:true
};

var TBloader = new Cubee().addmojo();

onDOMContentLoaded(function(){
	T.mix(yuiCfg,{modules:TBloader.modules});
	YUI(yuiCfg).use('info',function(Y){
		Y.mix(T,Y);
		for(var i = 0;i< TBloader.onReadys.length;i++){
			TBloader.onReadys[i].apply(this,[Y,TBloader]);
		}
	});
});
...
//widthout combine
var jsbase = jsbase || 'http://a.tbcdn.cn/app/dp/lite/';
TBloader.addmojo({
	//core mojos
	't-base':{
	...
	'jquery':{
		fullpath:jsbase+'cubee/tbwidget/jquery/jquery-1.3.2.min.js',
		requires:[]
	},
	//widget
	//评论组件
	...
	//分页组件皮肤
	't-pagination-skin':{
		fullpath:jsbase+'cubee/tbwidget/pagination/skin.css',
		type:'css'
	},
	//分页组件
	't-pagination':{
		fullpath:jsbase+'cubee/tbwidget/pagination/t-pagination.js',
		requires:['node','event','dump','anim','t-pagination-skin']
	},
	//分页组件2
	'pagination':{
		fullpath:jsbase+'cubee/tbwidget/pagination/t-pagination-2.js',
		requires:['widget']
	},
	//simpleditor组件
	't-simpleditor':{
	...
	'tipInput':{
		fullpath:jsbase+'cubee/tbwidget/tipinput/tipinput.js',
		requires:['yahoo-dom-event']
	},
	'slide':{
		fullpath:jsbase+'cubee/tbwidget/slide/slide.js',
		requires:['node','anim']
	},
	'box':{
		fullpath:jsbase+'cubee/tbwidget/box/box.js',
		requires:['box-skin-default','node','overlay','dd-plugin']
	},
	'box-skin-default':{
		fullpath:jsbase+'cubee/tbwidget/box/skin.css',
		type:'css'
	},
	'tip':{
		fullpath:jsbase+'cubee/tbwidget/tip/tip.js',
		requires:['node','anim']
	}
